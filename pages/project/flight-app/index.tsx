                    ...
                    <div className='max-w-[1056px] px-20 mx-auto mb-20 xxl:mb-24'>
                        <div className='mb-40 xxl:mb-48'>
                            <div>
                                ...
                                <p className='mt-8'>
                                    The one-on-one interviews are aimed at getting an indepth approach of how our targeted users engage booking of flight(both offline and on competitor’s websites), determine their pain points, challenges, what and what they would love to see change on such platforms and how to make things better overall. Questions like:
                                </p>
                                <p className='mt-8'>
