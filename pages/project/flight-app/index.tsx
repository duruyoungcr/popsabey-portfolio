            ...
            <Layout>
                <div className={styles.container}>
                    ...
                    <div className={styles.imgContainer}>
                        <Image data-aos='fade-up' data-aos-delay='100' src={CoverImage} width={1272} height={763} alt={title} placeholder='blur' />
                    </div>
                    ...
                    <div className='mb-8 sm:mb-16'>
                        ...
                        <p className='sm:mt-8' data-aos='fade-up' data-aos-delay='200'>
                            Deterrmine and understand the solution’s targeted audience.
                        </p>
                        <p className='sm:mt-8' data-aos='fade-up' data-aos-delay='300'>
                    ...
                    <div className='mb-10 sm:mb-40 xxl:mb-48'>
                        ...
                        <div>
                            <Image data-aos='fade-up' data-aos-delay='200' src={StepImage} width={1280} height={268} alt={title} placeholder='blur' />
                        </div>
                    </div>
                    <div className='max-w-[1056px] sm:px-20 mx-auto sm:mb-20 xxl:mb-24'>
                        <div className='mb-10 sm:mb-40 xxl:mb-48'>
                            <div>
                                ...
                                <p className='mt-8 font-medium' data-aos='fade-up' data-aos-delay='100'>
                                    USER INTERVIEWS
                                </p>
                                ...
                                <p className='mt-2 sm:mt-8' data-aos='fade-up' data-aos-delay='400'>
                            ...
                            <div className='my-10' data-aos='fade-up' data-aos-delay='500'>
                                <Image src={BoardImage} width={1055} height={632} alt={title} placeholder='blur' />
                            </div>
                            <div>
                                <p className='mt-8 font-medium' data-aos='fade-up'>
                                    COMPETITOR ANALYSIS
                                </p>
                                <p className='mt-2 sm:mt-8' data-aos='fade-up' data-aos-delay='100'>
                        ...
                        <div>
                            <div>
                                ...
                                <p className='sm:mt-10 font-medium' data-aos='fade-up' data-aos-delay='100'>
                                    ONBOARDING
                                </p>
                                <p className='mt-2 sm:mt-8' data-aos='fade-up' data-aos-delay='200'>
                                ...
                                <div className='my-10'>
                                    <Image data-aos='fade-up' data-aos-delay='400' src={OneImage} width={1056} height={610} alt={title} placeholder='blur' />
                                </div>
                                <p data-aos='fade-up'>
                            ...
                            <div>
                                ...
                                <div className='my-10'>
                                    <Image data-aos='fade-up' data-aos-delay='300' src={FourImage} width={1056} height={610} alt={title} placeholder='blur' />
                                </div>
                            </div>
                            <div>
                                ...
                                <div className='my-10'>
                                    <Image data-aos='fade-up' data-aos-delay='200' src={ThreeImage} width={1056} height={610} alt={title} placeholder='blur' />
                                </div>
                            </div>
                            <div>
                                <p className='font-medium' data-aos='fade-up'>
                                ...
                                <div className='my-10'>
                                    <Image data-aos='fade-up' data-aos-delay='200' src={TwoImage} width={1056} height={610} alt={title} placeholder='blur' />
                                </div>
                            </div>
                            <div>
                                <p className='font-medium' data-aos='fade-up'>
                                ...
                                <p className='mt-2 sm:mt-8' data-aos='fade-up' data-aos-delay='200'>THANK YOU.</p>
                            </div>
                        </div>
