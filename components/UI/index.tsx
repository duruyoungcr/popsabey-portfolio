...
const UI = () => {
    return (
        <div className={styles.container}>
            <p className='mb-10' data-aos='fade-right' data-aos-delay='100'>
            ...
            <div>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 mb-4 sm:mb-8'>
                    <div>
                        <Image data-aos='zoom-in' data-aos-delay='100' src={UI1} alt='ui_image' width='659' height='395' placeholder='blur' />
                    </div>
                    <div>
                        <Image data-aos='zoom-in' data-aos-delay='100' src={UI2} alt='ui_image' width='593' height='395' placeholder='blur' />
                    </div>
                </div>
                <div className='grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-5 mb-4 sm:mb-8'>
                    <div className='col-span-2 sm:col-span-1 max-h-[185px] sm:max-h-max'>
                        <Image data-aos='zoom-in' data-aos-delay='200' src={UI3} alt='ui_image' width='411' height='395' placeholder='blur' />
                    </div>
                    <div>
                        <Image data-aos='zoom-out' data-aos-delay='100' src={UI4} alt='ui_image' width='411' height='395' placeholder='blur' />
                    </div>
                    <div>
                        <Image data-aos='zoom-in' data-aos-delay='200' src={UI5} alt='ui_image' width='411' height='395' placeholder='blur' />
                    </div>
                </div>
                <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-4 sm:mb-8'>
                    <div className='sm:col-span-1' data-aos='fade-right' data-aos-delay='100'>
                        <Image src={UI6} alt='ui_image' width='518' height='395' placeholder='blur' />
                    </div>
                    <div className='sm:col-span-2' data-aos='fade-left' data-aos-delay='100'>
                        <Image src={UI7} alt='ui_image' width='734' height='395' placeholder='blur' />
                    </div>
                </div>
                <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-4 sm:mb-8'>
                    <div className='sm:col-span-2' data-aos='fade-right' data-aos-delay='100'>
                        <Image src={UI8} alt='ui_image' width='719' height='395' placeholder='blur' />
                    </div>
                    <div className='sm:col-span-1' data-aos='fade-left' data-aos-delay='100'>
