...
const Sell = () => {
    return (
        <div className="rounded-3xl border-[0.5px] border-black-light px-[49px] py-[43px] mx-20 lg:mx-[120px] text-[23px]">
            ...
            <p>
                In an environment where everything is confusing, hundreds and hundreds of choices to be made everyday, there is need for orderliness and simplicity in making those choices, I can shape and influence how those decisions are made for the better through intentional design.
            </p>
        </div>
    )
}
